...
class HrEmployee(models.Model):
    ...
    marital_status_id = fields.Many2one('hr.marital.status', string="Marital", tracking=True)
    required_restriction = fields.Boolean('Required Restriction', default=True, tracking=True)
    previous_regimen = fields.Boolean('Previous Regimen', tracking=True)
