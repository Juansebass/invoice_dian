...
class AccountInvoiceDianDocument(models.Model):
    ...
    def _generate_qr_code(self):
        ...
        nit_fac = self.company_id.partner_id._get_vat_without_verification_code()
        nit_adq = self.invoice_id.partner_id._get_vat_without_verification_code()
        cufe = self.cufe_cude
    ...
    def action_send_mail(self):
        ...
        template_id = self.env.ref('l10n_co_edi_ubl_dian.email_template_for_einvoice').id
        ...
        if self.invoice_id.l10n_co_edi_type in ('01', '02'):
    ...
    def _set_filenames(self):
        ...
        if self.company_id.partner_id._get_vat_without_verification_code():
            nnnnnnnnnn = self.company_id.partner_id._get_vat_without_verification_code().zfill(10)
        else:
    ...
    def _get_xml_values(self, ClTec):
        ...
        if self.invoice_id.l10n_co_edi_type == '02':
        ...
        NitOFE = supplier._get_vat_without_verification_code()
        NitAdq = customer._get_vat_without_verification_code()
        ClTec = False
        SoftwarePIN = 0
        ...
        document_type = supplier.l10n_latam_identification_type_id.l10n_co_document_code
        ...
        return {
            ...
            'ProviderIDschemeID': supplier._get_vat_verification_code(),
            'ProviderIDschemeName': supplier._l10n_co_edi_get_carvajal_code_for_identification_type(),
            'ProviderID': NitOFE,
            ...
            'PaymentMeansID': self.invoice_id.l10n_co_edi_payment_option_id.code,
            'PaymentMeansCode': self.invoice_id.l10n_co_edi_payment_option_id.code or '10',
    ...
    def _get_accepted_values(self):
        ...
        xml_values['CustomizationID'] = self.invoice_id.l10n_co_edi_operation_type
        active_dian_resolution = self.invoice_id._get_active_dian_resolution()
        xml_values['InvoiceControl'] = active_dian_resolution
        xml_values['InvoiceTypeCode'] = self.invoice_id.l10n_co_edi_type
    ...
    def _get_credit_note_values(self):
        xml_values = self._get_xml_values(False)
        if self.invoice_id.l10n_co_edi_operation_type == '10' or self.invoice_id.reversed_entry_id:
        ...
        if billing_reference:
            ...
            self.invoice_id.l10n_co_edi_operation_type = '20'
        elif self.invoice_id.l10n_co_edi_operation_type == '22':
            xml_values['CustomizationID'] = '22'
            self.invoice_id.l10n_co_edi_operation_type = '22'
            billing_reference = {
                'ID': False,
                'UUID': False,
                'IssueDate': False,
        ...
        xml_values['DiscrepancyResponseCode'] = self.invoice_id.l10n_co_edi_description_code_debit
        xml_values['DiscrepancyDescription'] = self.invoice_id.l10n_co_edi_description_code_debit.name
    ...
    def _get_debit_note_values(self):
        xml_values = self._get_xml_values(False)
        if self.invoice_id.l10n_co_edi_operation_type == '10' or self.invoice_id.debit_origin_id:
            billing_reference = self.invoice_id._get_billing_reference()
        else:
            billing_reference = False
        ...
        if billing_reference:
            ...
            self.invoice_id.l10n_co_edi_operation_type = '30'
        elif self.invoice_id.l10n_co_edi_operation_type == '32':
            xml_values['CustomizationID'] = '32'
            self.invoice_id.l10n_co_edi_operation_type = '32'
            billing_reference = {
                'ID': False,
                'UUID': False,
                'IssueDate': False,
