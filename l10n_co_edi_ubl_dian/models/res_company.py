...
class ResCompany(models.Model):
    ...
    def _get_GetNumberingRange_values(self):
        ...
        xml_soap_values['accountCode'] = self.partner_id._get_vat_without_verification_code()
        xml_soap_values['accountCodeT'] = self.partner_id._get_vat_without_verification_code()
