...
class ElectronicInvoiceFunctions(http.Controller):
    ...
    def approve_fe(self, token_id, rating, **kwargs):
        ...
        if invoice_id.invoice_rating != 'not_rating':
            return request.render('l10n_co_edi_ubl_dian.invoice_rating_refuse', {
        ...
        return request.render('l10n_co_edi_ubl_dian.approve_electronic_invoice_messages', {
    ...
    def feedback_fe(self, token_id, **kwargs):
        ...
        return request.render('l10n_co_edi_ubl_dian.electronic_invoice_notification_refuse', {'web_base_url': request.env['ir.config_parameter'].sudo().get_param('web.base.url'),'invoice': invoice_id,})
