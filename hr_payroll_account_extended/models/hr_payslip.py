    ...
    def get_partner(self, rule, employee):
        ...
        if rule:
            if rule.partner_type == 'layoffs':
                ...
                partner = employee.afc_partner_id
            elif rule.partner_type == 'compensation':
                partner = employee.ccf_partner_id
