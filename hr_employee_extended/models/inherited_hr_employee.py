...
class HrEmployeeContributorType(models.Model):
    _inherit = 'hr.employee.contributor.type'
...
class HrEmployeeContributorSubType(models.Model):
    _inherit = 'hr.employee.contributor.subtype'
...
class Employee(models.Model):
    ...
    contributor_type_id = fields.Many2one("hr.employee.contributor.type", string="Tipo Cotizante", tracking=True)
    contributor_subtype_id = fields.Many2one("hr.employee.contributor.subtype", string="SubTipo Cotizante", tracking=True)
