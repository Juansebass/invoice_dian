...
class SalaryIncreaseWizard(models.TransientModel):
    ...
    def create_news(self):
        ...
        if salary_increase_id.salary_type == 'sueldo_basico':
            type_salary = 'basic_salary'

        if salary_increase_id.salary_type == 'salario_integral':
            type_salary = 'integral_salary'

        if salary_increase_id.salary_type == 'apoyo_sostenimiento':
            type_salary = 'support_sustainability'

        for line in salary_increase_id.increase_lines_ids:

            if line.salary_type == 'sueldo_basico':
                type_salary = 'basic_salary'

            if line.salary_type == 'salario_integral':
                type_salary = 'integral_salary'

            if line.salary_type == 'apoyo_sostenimiento':
                type_salary = 'support_sustainability'
